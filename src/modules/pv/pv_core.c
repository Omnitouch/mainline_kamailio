...
static str pv_uri_scheme[] = {{"none", 4}, {"sip", 3}, {"sips", 4}, {"tel", 3},
		{"tels", 4}, {"urn", 3}, {0, 0}};
static char _empty_str[] = "";

static str pv_af_list[] = {{"IPv4", 4}, {"IPv6", 4}, {0, 0}};
int _pv_pid = 0;
...
int pv_get_udp(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
...
int pv_get_true(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
...
int pv_get_pid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(_pv_pid == 0)
		_pv_pid = (int)getpid();
...
int pv_get_method(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
	...
	return pv_get_strintval(
			msg, param, res, &get_cseq(msg)->method, get_cseq(msg)->method_id);
}

int pv_get_methodid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
	...
	return pv_get_uintval(
			msg, param, res, (unsigned int)(get_cseq(msg)->method_id));
}

int pv_get_msgtype(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	unsigned int type = 0;
...
int pv_get_msgtypes(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	char *types = "xx";
...
int pv_get_version(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
	...
	if(msg->first_line.type == SIP_REQUEST) {
		return pv_get_strval(
				msg, param, res, &msg->first_line.u.request.version);
	}

	return pv_get_strval(msg, param, res, &msg->first_line.u.reply.version);
}

int pv_get_status(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_statusi(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_reason(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_ruri(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
		...
		pv_param_t *param, pv_value_t *res)
{
	if(param->pvn.u.isname.name.n == 1) /* username */
	{
		...
		return pv_get_strintval(
				msg, param, res, &parsed_uri->port, (int)parsed_uri->port_no);
		...
		return pv_get_strintval(msg, param, res,
				&pv_uri_scheme[parsed_uri->type], (int)parsed_uri->type);
...
int pv_get_errinfo_attr(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_null(msg, param, res);
}
...
int pv_get_cseq_body(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_msg_buf(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(msg == NULL)
		return -1;
...
int pv_get_msg_len(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_flags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_flag(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
	...
	return pv_get_uintval(msg, param, res,
			(msg->flags & (1 << param->pvn.u.isname.name.n)) ? 1 : 0);
}
...
int pv_get_hexflags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(msg == NULL || res == NULL)
		return -1;
...
int pv_get_bflags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	flag_t flags;
...
int pv_get_bflag(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	flag_t flags;
	if(getbflagsval(0, &flags) < 0) {
		ERR("pv_get_bflags: Error while obtaining values of branch flags\n");
	...
	return pv_get_uintval(msg, param, res,
			(flags & (1 << param->pvn.u.isname.name.n)) ? 1 : 0);
}

int pv_get_hexbflags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	flag_t flags;
	str s;
	if(res == NULL)
...
int pv_get_sflags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_uintval(msg, param, res, getsflags());
}

int pv_get_sflag(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)

{
	...
	return pv_get_uintval(msg, param, res,
			(getsflags() & (1 << param->pvn.u.isname.name.n)) ? 1 : 0);
}

int pv_get_hexsflags(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(res == NULL)
		return -1;
...
int pv_get_callid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_srcip(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(msg == NULL)
		return -1;
...
int pv_get_srcipz(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(msg == NULL)
		return -1;
...
int pv_get_srcport(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_srcaddr_uri_helper(
		struct sip_msg *msg, pv_param_t *param, int tmode, pv_value_t *res)
{
	str uri;
	str sr;
...
int pv_get_srcaddr_uri(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_srcaddr_uri_helper(msg, param, 0, res);
}

int pv_get_srcaddr_uri_full(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_srcaddr_uri_helper(msg, param, 1, res);
}

int pv_get_rcvip(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_rcvport(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_rcvsname(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_rcvaddr_uri(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_rcvaddr_uri_helper(msg, param, 0, res);
}

int pv_get_rcvaddr_uri_full(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	return pv_get_rcvaddr_uri_helper(msg, param, 1, res);
}

int pv_get_rcvaddr_socket(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	if(msg->rcv.bind_address != NULL
		...
		return pv_get_strval(
				msg, param, res, &msg->rcv.bind_address->useinfo.address_str);
	}

	return pv_get_rcvip(msg, param, res);
}

int pv_get_rcv_advertised_port(
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_rcvadv_uri(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_af(sip_msg_t *msg, pv_param_t *param, pv_value_t *res)
{
	...
	switch(param->pvn.u.isname.name.n) {
		...
		default:
			return pv_get_uintval(
					msg, param, res, msg->rcv.bind_address->address.af);
	}
}

int pv_get_force_sock(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	return pv_get_intstrval(msg, param, res,
			(int)msg->force_send_socket->port_no,
			&msg->force_send_socket->port_no_str);
}

int pv_get_useragent(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_refer_to(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_diversion(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str *val;
	str name;
...
int pv_get_rpid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_ppi_attr(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	int idxf;
	int idx;
	struct sip_uri *uri;
	...
	if(param->pvn.u.isname.name.n == 4) { /* display name */
		if(ppi_uri->display.s == NULL || ppi_uri->display.len <= 0) {
...
int pv_get_pai(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	int idxf;
	int idx;
...
int pv_get_protoid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_dset(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str s;
	if(msg == NULL)
		return -1;
...
int pv_get_dsturi(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_dsturi_attr(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	struct sip_uri uri;
	...
	if(param->pvn.u.isname.name.n == 1) /* domain */
	{
		...
		if(uri.transport_val.s == NULL)
			return pv_get_udp(msg, param, res);
		return pv_get_strintval(
				msg, param, res, &uri.transport_val, (int)uri.proto);
	}
...
int pv_get_content_type(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
		...
		struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	return pv_get_intstrval(msg, param, res,
			(int)(long)msg->content_length->parsed, &msg->content_length->body);
}
...
static inline str *cred_user(struct sip_msg *rq)
{
	...
	if(!h)
		get_authorized_cred(rq->authorization, &h);
	if(!h)
		return 0;
...
int pv_get_acc_username(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
...
int pv_get_branch(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str branch;
	qvalue_t q;
...
int pv_get_branches(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	str uri;
	str s;
	qvalue_t q;
...
int pv_get_avp(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	if(idx < 0) {
		n = 1;
		avp0 = avp;
		while((avp0 = search_next_avp(&state, &avp_value0)) != 0)
			n++;
		idx = -idx;
		if(idx > n) {
	...
	n = 0;
	while(n < idx && (avp = search_next_avp(&state, &avp_value)) != 0)
		n++;
		...
		do {
			...
			if(p - p_ini + hf->body.len + 1 > p_size) {
				LM_ERR("local buffer length exceeded [%d/%d]!\n",
						(int)(p - p_ini + hf->body.len + 1), hf->body.len);
				return pv_get_null(msg, param, res);
			}
...
int pv_get_hfl(sip_msg_t *msg, pv_param_t *param, pv_value_t *res)
{
		...
		if(idx < 0) {
			...
			for(hf = msg->h_via1; hf != NULL; hf = hf->next) {
				if(hf->type == HDR_VIA_T) {
					for(vb = (via_body_t *)hf->parsed; vb != NULL;
							vb = vb->next) {
						n++;
					}
				}
	...
	if((tv.flags == 0)
			&& (tv.ri == HDR_RECORDROUTE_T || tv.ri == HDR_ROUTE_T)) {
		...
		if(idx < 0) {
			...
			for(; hf != NULL; hf = hf->next) {
				if(hf->type == tv.ri) {
					...
					for(rrb = (rr_t *)hf->parsed; rrb != NULL;
							rrb = rrb->next) {
						n++;
					}
				}
	...
	if((tv.flags == 0) && (tv.ri == HDR_CONTACT_T)) {
		...
		for(hf = msg->contact; hf != NULL; hf = hf->next) {
			if(hf->type == HDR_CONTACT_T) {
				for(cb = (((contact_body_t *)hf->parsed)->contacts); cb != NULL;
						cb = cb->next) {
					if(n == idx) {
						sval.s = cb->name.s;
						sval.len = cb->len;
 ...
 *
 */
int pv_get_scriptvar(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	int ival = 0;
	char *sval = NULL;
...
int pv_get_server_id(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	...
	switch(pv->type) {
		...
		case PVT_XAVP: {
			...
			if(xname->index.type == PVT_EXTRA) {
				/* Get root index */
				if(pv_get_spec_index(
						   msg, &xname->index.pvp, &root_idx_spec, &root_idxf)
						!= 0) {
					LM_ERR("invalid XAVP root index\n");
					return pv_get_null(msg, param, res);
				}
				if(!(root_idxf == PV_IDX_ALL))
					root_all = 0;
			}
			if(!root_all) {
			...
			if(xname_sub == NULL) {
				...
				if(xname_sub->index.type == PVT_EXTRA) {
					/* Get sub index */
					if(pv_get_spec_index(msg, &xname_sub->index.pvp,
							   &sub_idx_spec, &sub_idxf)
							!= 0) {
						LM_ERR("invalid XAVP sub index\n");
						return pv_get_null(msg, param, res);
					}
					if(!(sub_idxf == PV_IDX_ALL))
						sub_all = 0;
				}
					...
					if(ravp && ravp->val.type == SR_XTYPE_XAVP) {
						if(sub_all) {
							...
							if(sub_idx_spec >= 0) {
								...
								count = xavp_count(
										&xname_sub->name, &ravp->val.v.xavp);
								sub_idx = count + sub_idx_spec;
							}
							sub_avp = xavp_get_by_index(&xname_sub->name,
									sub_idx, &ravp->val.v.xavp);
							if(sub_avp)
								n = 1;
						}
					}
						...
						if(ravp->val.type == SR_XTYPE_XAVP) {
							if(sub_all) {
								...
								if(sub_idx_spec >= 0) {
									...
									count = xavp_count(&xname_sub->name,
											&ravp->val.v.xavp);
									sub_idx = count + sub_idx_spec;
								}
								sub_avp = xavp_get_by_index(&xname_sub->name,
...
int pv_get_ruid(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
...
int pv_get_location_ua(struct sip_msg *msg, pv_param_t *param, pv_value_t *res)
{
	if(msg == NULL)
		return -1;
		...
		struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	...
	if(set_var_value((script_var_t *)param->pvn.u.dname, &avp_val, flags)
			== NULL) {
...
int pv_set_ruri(struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	struct action act;
		...
		struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	...
	if(km_append_branch(
			   msg, &val->rs, 0, 0, Q_UNSPECIFIED, 0, msg->force_send_socket)
			!= 1) {
...
int pv_set_to_username(
		struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	return pv_set_to_attr(msg, param, op, val, 1);
}

int pv_set_to_domain(
		struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	return pv_set_to_attr(msg, param, op, val, 2);
}

int pv_set_to_display(
		struct sip_msg *msg, pv_param_t *param, int op, pv_value_t *val)
{
	return pv_set_to_attr(msg, param, op, val, 3);
}

int pv_set_from_attr(struct sip_msg *msg, pv_param_t *param, int op,
		pv_value_t *val, int type)
{
	if(msg == NULL)
		return -1;
 ...
 *
 */
int pv_get__s(sip_msg_t *msg, pv_param_t *param, pv_value_t *res)
{
	str sdata = {0};
	pv_elem_t *fmt = NULL;
...
int pv_get_rpl_attrs(sip_msg_t *msg, pv_param_t *param, pv_value_t *res)
{
	...
	switch(param->pvn.u.isname.name.n) {
		case 0: /* dst uri */
			...
			suri.len = snprintf(rpluribuf, MAX_URI_SIZE,
					"sip:%.*s:%u;transport=%.*s", host.len, host.s, port,
					sproto.len, sproto.s);
		...
		case 3: /* dst proto */
			...
			return pv_get_strintval(
					msg, param, res, &sproto, (int)msg->via2->proto);
		case 4: /* dst protoid */
...
int pv_get_ccp_attrs(sip_msg_t *msg, pv_param_t *param, pv_value_t *res)
{
	...
	LM_DBG("getting value for variable: %.*s.%.*s\n", gname.len, gname.s,
			vname.len, vname.s);
	ret = cfg_get_by_name(_pv_ccp_ctx, &gname, grpid, &vname, &val, &vtype);
	if(ret < 0) {
		...
		sip_msg_t *msg, via_body_t *vb, pv_param_t *param, pv_value_t *res)
{
	...
	switch(param->pvn.u.isname.name.n) {
		...
		case 1: /* port */
			return pv_get_uintval(
					msg, param, res, (vb->port) ? vb->port : SIP_PORT);
		case 2: /* proto */
...
int pv_get_vparam_ival(sip_msg_t *msg, pv_param_t *param)
{
	...
	if(param->pvn.type == PV_NAME_PVAR) {
		/* pvar */
		if(pv_get_spec_value(msg, (pv_spec_t *)(param->pvn.u.dname), &vval)
				!= 0) {
 ...
 *
 */
int pv_set_msgbuf(sip_msg_t *msg, pv_param_t *param, int op, pv_value_t *val)
{
	int n;
